...
names_est <- c("Oracle", "IBS", "c.1b1", "c.1b2", "c.1b3", "c1b1", "c1b2", "c1b3", "Lc.1b1", "Lc.1b2", "Lc.1b3", "Lc1b1", "Lc1b2", "Lc1b3")
...
for(n in 1 : length(sq_n))
{
  ...
  frob_all[n, 3 : 14] <- c(colMeans(forb_ebs[n, , ]), colMeans(forb_ebs_ls[n, , ]))
...
col_choic <- c("red", "steelblue", "brown", "tomato", "green", "slateblue",  "magenta3", "palegreen" , "brown", "tomato", "green", "slateblue",  "magenta3", "palegreen" )
...
pdf("out/Lmcover_dim5.pdf", height = 6, width = 7)
...
pdf("out/Lfrob_dim5.pdf", height = 6, width = 7)
...
pdf("out/Lsimul_dim5.pdf", height = 6, width = 7)
...
pdf("out/Lrelvol_dim5.pdf", height = 6, width = 7)
