...
#load("C:/Users/Hp/Documents/GitHub/Batch_Means_Online/linear/out/linear_cns1_0pt0005_indep_n_5e+06_dim_20.RData")
...
pdf("C:/Users/Hp/Documents/GitHub/Batch_Means_Online/linear/out/cover_rates_cns1_0pt0005_linear_indep_dim_20.pdf",         # File name
...
pdf("C:/Users/Hp/Documents/GitHub/Batch_Means_Online/linear/out/volume_cns1_0pt0005_linear_indep_dim_20.pdf",         # File name
    width = 11, height = 12, # Width and height in inches
    bg = "white",          # Background color
    colormodel = "cmyk")          # Paper size

plot(sq_n, volm_all[, 1], type = "b", lwd = 2, lty = 6, xlab = "Log Sample Size", ylab = "Volume", col = "red", ylim = c(0.3,1.01))
...
pdf("C:/Users/Hp/Documents/GitHub/Batch_Means_Online/linear/out/relative_cns1_0pt0005_frobenius_indep_dim_20.pdf",         # File name
    width = 11, height = 12, # Width and height in inches
    bg = "white",          # Background color
    colormodel = "cmyk")          # Paper size
...
for(n in 1:length(sq_n)){
  ...
  forb_norm_all[n, 3 : 8] <- c(colMeans(forb_ebs_norm[n, , ]), colMeans(forb_ebs_norm_ls[n, , ]))
  
  sd_forb_norm[n, 1] <- 0
  sd_forb_norm[n, 2] <- sd( forb_ibs_norm[, n]) / sqrt(Reps)
  sd_forb_norm[n, 3 : 8] <- c(apply(forb_ebs_norm[n, , ], 2, sd), apply(forb_ebs_norm_ls[n, , ], 2, sd)) / sqrt(Reps)
...
pdf("C:/Users/Hp/Documents/GitHub/Batch_Means_Online/linear/out/self_frobenius_cns1_0pt0005_indep_dim_20.pdf",         # File name
    width = 11, height = 12, # Width and height in inches
    bg = "white",          # Background color
    colormodel = "cmyk")          # Paper size

plot(sq_n, forb_norm_all[, 1], type = "b", lwd = 2, lty = 6, xlab = "Log Sample Size", ylab = "Self Frobenius", col = "red", ylim = c(1.5,5.3))
...
pdf("C:/Users/Hp/Documents/GitHub/Batch_Means_Online/linear/out/inter_ratio_first_comp_linear_indep_cns1_0pt0005_dim_20.pdf",         # File name
    width = 11, height = 12,   # Width and height in inches
    bg = "white",          # Background color
    colormodel = "cmyk")          # Paper size
...
pdf("C:/Users/Hp/Documents/GitHub/Batch_Means_Online/linear/out/marg_sim_cov_rates_linear_indep_cns1_0pt0005_dim_20.pdf",         # File name
    width = 11, height = 12,   # Width and height in inches
    bg = "white",          # Background color
    colormodel = "cmyk")          # Paper size
...
pdf("C:/Users/Hp/Documents/GitHub/Batch_Means_Online/linear/out/marg_volm_rates_linear_indep_cns1_0pt0005_dim_20.pdf",         # File name
    width = 11, height = 12,   # Width and height in inches
    bg = "white",          # Background color
    colormodel = "cmyk")          # Paper size

plot(sq_n, marg_covg_volm[, 1], type = "b", lwd = 2, lty = 6, xlab = "Log Sample Size", ylab = "Volume Ratio of Marginal to Joint Confidence Regions", col = "red", ylim = c(10, max(marg_covg_volm)))
